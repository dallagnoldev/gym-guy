...
public class WorkoutController {
    ...
    @GetMapping
    public ResponseEntity<List<WorkoutResponseDTO>> findAllByUser(@PathVariable Long userId) {
        return ResponseEntity.ok(workoutService.findAllWorkoutsByUserId(userId));
    }
